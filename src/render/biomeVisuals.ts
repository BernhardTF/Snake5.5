...
export const BIOME_VISUALS: Record<BiomeId, BiomeVisual> = {
  ...
  pinksands: {
    ...
    sunDir: n3(-0.36, 0.44, 0.82),
    sun: [1.36, 1.27, 1.13],
    sky: [0.19, 0.26, 0.35],
    ground: [0.24, 0.16, 0.14],
    sandA: '#e3ab9d', sandB: '#fbeee7', sandC: '#c22538',
    depthScale: 0.16,
    sim: { diffusion: 0.0009, talus: 3.5, erode: 0, windX: 0, windY: 0, smear: 0, heatSet: 1, bDecay: 1 / 30, waves: false, lap: { edge: 2.1, amp: 0.55 } },
    grade: { lift: [0.0, 0.004, 0.012], gamma: [1.0, 1.0, 1.0], gain: [1.02, 0.99, 0.99], sat: 1.08, contrast: 1.08, vignette: 0.3, exposure: 0.9 },
  ...
  dallol: {
    ...
    grade: { lift: [0.005, 0.008, 0.0], gamma: [1.0, 1.0, 1.02], gain: [1.02, 1.02, 0.97], sat: 1.12, contrast: 1.1, vignette: 0.32, exposure: 0.8 },
  ...
  mars: {
    ...
    sun: [1.45, 1.12, 0.84],
    sky: [0.28, 0.19, 0.13],
    ground: [0.2, 0.1, 0.055],
    sandA: '#9e6c4c', sandB: '#bd9170', sandC: '#684030',
    depthScale: 0.15,
    sim: { diffusion: 0.0006, talus: 4, erode: 0, windX: 0.85, windY: 0.52, smear: 0, heatSet: 0, bDecay: 0, waves: false, devils: true },
    grade: { lift: [0.02, 0.008, 0.0], gamma: [1.0, 1.01, 1.03], gain: [1.03, 0.98, 0.92], sat: 0.94, contrast: 1.06, vignette: 0.45, exposure: 1.0 },
  ...
  kepler: {
    id: 'kepler', index: 11,
    sunDir: n3(-0.8, 0.3, 0.48),
    sun: [1.3, 0.62, 0.22],
    sun2Dir: n3(0.6, 0.62, 0.5),
    sun2: [0.2, 0.58, 1.1],
    sky: [0.1, 0.06, 0.16],
    ground: [0.07, 0.04, 0.1],
    sandA: '#a192b9', sandB: '#d3c6ec', sandC: '#54427a',
    depthScale: 0.16,
    sim: { diffusion: 0.0009, talus: 4, erode: 0, windX: 0.6, windY: 0.8, smear: 0, heatSet: 1, bDecay: 1 / 9, waves: false },
    grade: { lift: [0.02, 0.0, 0.035], gamma: [1.0, 1.02, 0.98], gain: [1.03, 0.96, 1.05], sat: 0.98, contrast: 1.1, vignette: 0.45, exposure: 0.95 },
